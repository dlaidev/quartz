...
Multiplication of two N×N matrices is strictly more expensive than O(N²),
regardless of which multiplication algorithm you use. So every time you trade one block multiplication
for any bounded number of block additions, you're replacing a superquadratic operation with quadratic ones.
The additions become asymptotically free.
